...
row_mass=nrow(mass)
mass_out=cbind(mass,Neu5Ac=rep(0,row_mass),HexNAc=rep(0,row_mass),Hex=rep(0,row_mass),Fuc=rep(0,row_mass),Red_HexNAc=rep(0,row_mass),deviation=rep(0,row_mass)) 
          ...
          for( Hex_n in 0:m)
            for( Fuc_n in 0:n)
              ...
              
              {
                ...
                {  y=c(Neu5Ac_n,HexNAc_n,Hex_n,Fuc_n,Red_HexNAc_n,deviation) 
                return(y)}}
}
